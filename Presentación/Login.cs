...
//Aquí defino y le doy características a cada item que va dentro del form, incluyendo paneles, botones, etc.
        ...
        Image lbg = Image.FromFile($"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/loginbg.jpg");
      ...
      usu = new txtbx(usutextbg,usutextTitleLabel,"C.I",textUsu,panelder,234,new Point(43,250),"ci",cicheck);
       ...
       txtbxPassword = new txtbx(passtextbg,passtextTitleLabel,"Contraseña",textPass,panelder,234,new Point(43,309),"pass",passcheck,cbshow);
        ...
        btnacc.BackgroundImage = Image.FromFile($"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/boton_no.png");
        panelder.Controls.Add(btnacc);
     
        btnclose = new PictureBox();
        btnclose.Location = new Point(panelfull.Right - 30,10);
        Image btnc = Image.FromFile($"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/btnclose.png");
        ...
        Image btnm = Image.FromFile($"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/btnmin.png");
        ...
        Image logo = Image.FromFile($"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/logo.png");
    ...
    */
    ...
    private void Tglevent(object sender, EventArgs e)
    {
        if (panelder.Dock == DockStyle.Left)
        {
            ...
            Image lbg = Image.FromFile($"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/signinbg.jpg");
            panelfull.BackgroundImage = new Bitmap(lbg, 1024, 650);

            btnacc.Size = new Size(131, 51);
            btnacc.Location = new Point(112, 430);
            btnacc.BackgroundImage = Image.FromFile($"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/Siguiente_0.png");
        }
        ...
        else
        {
           ...
           panelfull.Controls.Remove(cuenta);
            btnacc.BackgroundImage =
                Image.FromFile(
                    $"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/boton_no.png");
        }
    ...
    private void UpdateButtonAppearance()
    {
        ...
        if (logcheck)
        {
            ...
            btnacc.BackgroundImage = Image.FromFile($"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/boton_si.png");
        }
        else
        {
        ...
        else
        {
            ...
            if (logcheck)
            {
                ...
                // Por ejemplo, si el botón se llama "btnEnviar":
                Image.FromFile(
                    $"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/Siguiente_A.png");
            }
            else
            {
                // Cambiar el aspecto del botón cuando no todos los txtbx tienen un valor
                ...
                btnacc.BackgroundImage =
                    Image.FromFile(
                        $"{Path.GetFullPath(".").Split("Proyecto-orange")[0]}Proyecto-orange/Presentación/Resources/Siguiente_0.png");
            }  
        }
    }
